...
ERROR_MESSAGE = "Oops! An exception occurred! \n\n**Error** : {} " \
            "\n\nTell in My Support @senjasupportt Oh Errors 😱" \
...
async def main(_, msg):
    await msg.reply(
        "sᴇʟᴇᴄᴛ ʏᴏᴜʀ sᴛʀɪɴɢ ᴛᴇʟᴇᴛʜᴏɴ/ᴘʏʀᴏɢʀᴀᴍ",
...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} STRING SESSION** \n\n`{}` \n\nGenerated by @senjastring_robot".format("TELETHON" if telethon else "PYROGRAM", string_session)
    await client.send_message("me", text)
    await client.disconnect()
    await phone_code_msg.reply("ʙᴇʀʜᴀsɪʟ ᴍᴇɴɢᴀᴍʙɪʟ {} sᴛʀɪɴɢ sᴇssɪᴏɴ. \n\nsᴛʀɪɴɢ sᴇssɪᴏɴ ᴍᴜ sᴜᴅᴀʜ ᴅɪᴋɪʀɪᴍ ᴅɪ ᴘᴇsᴀɴ ᴛᴇʀsɪᴍᴘᴀɴᴍᴜ!ᴄᴇᴋ ᴘᴇsᴀɴ ᴛᴇʀsɪᴍᴘᴀɴ \n\nʙʏ @senjastring_robot".format("telethon" if telethon else "pyrogram"))
