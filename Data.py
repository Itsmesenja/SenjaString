...
class Data:
    # Start Message
    START = """
ʜᴇʏ {} [🚀](https://telegra.ph/file/8b32a9a154d85b07d6f37.jpg)
...
ᴀɴᴅᴀ ᴅᴀᴘᴀᴛ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ sᴀʏᴀ ᴜɴᴛᴜᴋ ᴍᴇɴɢʜᴀsɪʟᴋᴀɴ sᴇssɪᴏɴ sᴛʀɪɴɢ ᴘʏʀᴏɢʀᴀᴍ ᴅᴀɴ ᴛᴇʟᴇᴛʜᴏɴ. ɢᴜɴᴀᴋᴀɴ ᴛᴏᴍʙᴏʟ ᴅɪʙᴀᴡᴀʜ ɪɴɪ ᴜɴᴛᴜᴋ ᴛᴀʜᴜ ʟᴇʙɪʜ ʙᴀɴʏᴀᴋ!
    ...
    buttons = [
        ...
        [InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="https://t.me/senjasupportt")],
    ]
...
sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : [sᴇɴᴊᴀ sᴜᴘᴘᴏʀᴛ](https://t.me/senjasupportt)
